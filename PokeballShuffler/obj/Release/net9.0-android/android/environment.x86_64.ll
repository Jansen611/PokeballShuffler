...
@aot_dso_cache = dso_local local_unnamed_addr global [765 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x52c1d3ac39fa07a9, ; from name: PokeballShuffler.dll.so
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	}, ; 224
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x67bb6d9588665002, ; from name: aot-PokeballShuffler
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6ab568baad61472d, ; from name: PokeballShuffler
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7922a35bdc9858cb, ; from name: aot-PokeballShuffler.so
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x80efaaa82e9d675a, ; from name: libaot-PokeballShuffler
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8102e5780c9ddc84, ; from name: libaot-PokeballShuffler.dll.so
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa16c621deb43406f, ; from name: PokeballShuffler.so
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe95d004b73f50068, ; from name: libaot-PokeballShuffler.so
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xee683942d63a6d1b, ; from name: aot-PokeballShuffler.dll.so
		i64 u0x8102e5780c9ddc84, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokeballShuffler.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.pokeballshuffler\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [31 x i8] c"libaot-PokeballShuffler.dll.so\00", align 16
